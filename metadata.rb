...
attribute 'network_management/dhcp',
  ...
  :choice       => [ "true", "false" ],
  :required     => "required",
  :dependent    => [ { "field" => "network_management/ip_address", "validator" => "isfalse" } , { "field" => "network_management/dhcp", "validator" => "isfalse" } , { "field" => "network_management/dhcp", "validator" => "isfalse" } , { "field" => "network_management/dhcp", "validator" => "isfalse" } , { "field" => "network_management/dhcp", "validator" => "isfalse" } ],
  :default      => "true",
  :order        => "1",
  :recipes      => [ 'workstation_management::network_management' ]
